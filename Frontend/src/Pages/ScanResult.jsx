  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            <div>
              <h1 className="text-2xl font-bold text-white mb-2">
                Scan Results: {scanResult.repo_name || "Unknown Repository"}
              </h1>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-yellow-300">
                  We found {scanResult.findings?.length || 0} issues so far.
          ...
          <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-6">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex items-center">
                <span className="bg-red-500/20 text-red-400 px-2 py-1 rounded text-sm mr-2">
                  {scanResult.findings.filter(f => f.Verified).length} Verified
                </span>
                <span className="bg-yellow-500/20 text-yellow-400 px-2 py-1 rounded text-sm">
                  {scanResult.findings.filter(f => !f.Verified).length} Unverified
                </span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              {scanResult.findings.map((finding, index) => (
                <div
                  key={index}
                  className={`bg-gray-700/30 border-l-4 ${
        ...
        {isCompleted && (!scanResult.findings || scanResult.findings.length === 0) && (
